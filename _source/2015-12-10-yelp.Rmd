...
businessData <- stream_in(file("~/Personal/Capstone Stuff/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_business.json"),verbose = FALSE)
...
ggmap(LV) + geom_point(data = clustData, aes(x = longitude, y = latitude,colour=db)) 
```
