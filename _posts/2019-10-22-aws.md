...
In this post, I'll briefly discuss the subject areas that you'll need to know in context of AWS Certified Solutions-Associate exam. I've tried to curate a list of the most useful resources that I've found for the preparation of the test. I'll also try to provide key points to remember for some AWS services where you might not to invest a lot of time to go through the service stack. Please note that in each Sections, I'm listing the most important service components; please do not take them as exam dumps. 

## AWS Services

For AWS exam, there are a some services that you'd need to be completely comfortable with. For the test, the most important services are EC2, S3, VPC, RDS, DynamoDB, route 53, KMS and IAM. If you have a good understanding of these services, there is a good chance that you'll clear the examination. I'd suggest to either puruse the official documents for each, or if you prefer video lectures, follow the <a href="https://linuxacademy.com/course/aws-certified-solutions-architect-2019-associate-level/" target="_blank"> Linux Academy course</a>. I prefer the former, as you can study at a faster pace, and it is easier to eye ball the important information via text. In my experience, I've found the videos to be rambling about topics that were not too important for the exam.

### EC2:
This is the most important AWS service in the context of examination. The Examination questions will be about:

1. Selecting instance family based on task.
